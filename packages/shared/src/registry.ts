...
export const PAGE_SCANNERS: ScannerExecutableDefinition[] = [
  ...
  {
    internalKey: 'STRUCTURED_DATA',
    featureId: 'LG-040',
    name: 'Structured Data (JSON-LD/Microdata/RDFa) Scanner',
    category: 'SEO',
    scope: 'PAGE',
    severityPolicy: 'MEDIUM',
    version: 'v1',
    enabled: true,
    run: (page: PageRecord, ctx?: ScannerContext) => runStructuredDataScanner(page, ctx),
  },
  {
    internalKey: 'HREFLANG',
    featureId: 'LG-041',
    name: 'Hreflang International SEO Scanner',
    category: 'SEO',
    scope: 'PAGE',
    severityPolicy: 'MEDIUM',
    version: 'v1',
    enabled: true,
    run: (page: PageRecord, ctx?: ScannerContext) => runHreflangScanner(page, ctx),
  },
];
