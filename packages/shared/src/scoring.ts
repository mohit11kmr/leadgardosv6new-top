...
export const SCORE_RULES_V3: Record<string, ScoreRule> = {
  ...
  // Detection Intelligence P1 (LG-040 to LG-044) — structured data, hreflang,
  // consent/CMP + consent-tracking correlation, duplicate content. Impact
  // values chosen conservatively relative to the established pillar scale
  // above (e.g. TLS_ERROR=30, CANONICAL_MISSING=5) — none of these represent
  // a fabricated/invented number; they slot into the same 0-100 deduction
  // scale every other rule already uses.
  ...
  STRUCTURED_DATA_DUPLICATE_TYPE: {
    ruleId: 'LG-040',
  ...
  TRACKER_FIRED_BEFORE_CONSENT_GA4: {
    ruleId: 'LG-043',
    internalKey: 'TRACKER_FIRED_BEFORE_CONSENT_GA4',
    normalizedIssueKey: 'TRACKER_FIRED_BEFORE_CONSENT_GA4',
    category: 'SECURITY',
    defaultImpact: 4,
    severity: 'MEDIUM',
    aggregationPolicy: 'ONCE_PER_WEBSITE',
  ...
  TRACKER_FIRED_BEFORE_CONSENT_META_PIXEL: {
    ruleId: 'LG-043',
    internalKey: 'TRACKER_FIRED_BEFORE_CONSENT_META_PIXEL',
    normalizedIssueKey: 'TRACKER_FIRED_BEFORE_CONSENT_META_PIXEL',
    category: 'SECURITY',
    defaultImpact: 4,
    severity: 'MEDIUM',
    aggregationPolicy: 'ONCE_PER_WEBSITE',
  ...
  TRACKER_FIRED_BEFORE_CONSENT_GTM: {
    ruleId: 'LG-043',
    internalKey: 'TRACKER_FIRED_BEFORE_CONSENT_GTM',
    normalizedIssueKey: 'TRACKER_FIRED_BEFORE_CONSENT_GTM',
    category: 'SECURITY',
    defaultImpact: 4,
    severity: 'MEDIUM',
    aggregationPolicy: 'ONCE_PER_WEBSITE',
